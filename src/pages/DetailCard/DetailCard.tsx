...
import {useGetFactsQuery, useGetFilmQuery} from "../../store/FilmsApi";
import Loader from "../../components/Loader/Loader";
import Btn from "../../components/Ui/Btn/Btn";
import {IFilm} from "../../models/models";
import Tabs from "../../components/Tabs/Tabs";
import FilmsTop from "../../components/FilmsTop/FilmsTop";
            ...
            <div className="flex mt-3">
                ...
                <div className="w-1/3 ml-6">
                    ...
                    <div className="mt-4 flex ">
                        <div><Btn className=" inline-flex items-center">
                            <svg stroke="currentColor" fill="none" stroke-width="2" viewBox="0 0 24 24"
                                 height="14" width="14"
                                 xmlns="http://www.w3.org/2000/svg">
                                <polygon points="5 3 19 12 5 21 5 3"></polygon>
                            </svg>
                            <span className="ml-2">Смотреть</span> </Btn></div>
                        <div className="ml-2"><Btn>
                    ...
                    <ul className="mt-3">
                        {data.countries.length &&
                            <Li><b>Страны:</b> {data.countries.map(e => e.country)}</Li>
                        }
                        {data.genres.length &&
                            <Li>
