...
const Teaser = () => {
    ...
    const {isLoading, isError, data: film} = useGetFilmQuery<any>(1198811)
    // console.log(film.kinopoiskId)
    ...
    return (
            ...
            <div className={s.teaser}>
                ...
                <div className={`${s.teaser__wrap} container mx-auto`}>
                    ...
                    <div className={s.teaser__genre}>
                        ...
                        {film.genres &&
                            film
                                .genres?.map((item: Genre, idx: number) => <span key={idx}> {item.genre}, </span>)
                        }
                    </div>
                    ...
                    <div className={s.teaser__btns}>
                        ...
                        <Btn>
                            <NavLink to={`detail/${film.kinopoiskId}`}> Подробнее</NavLink></Btn>
                        <Btn>
